...
if ( ! function_exists( 'supermag_skip_to_content' ) ) :
	...
	function supermag_skip_to_content() {
		...
		?>
		<a class="skip-link screen-reader-text" href="#<?php echo esc_attr( $supermag_content_id ); ?>" title="link"><?php esc_html_e( 'Skip to content', 'supermag' ); ?></a>
		<?php
	}
endif;
					...
					<div class="wrapper">
						<div class="site-branding clearfix">
							<?php if ( 'disable' != $supermag_customizer_all_values['supermag-header-id-display-opt'] ) : ?>
								...
								<?php
							endif;/*supermag-header-id-display-opt*/
