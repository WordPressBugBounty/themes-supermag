	...
	class Supermag_Theme_Info {
			...
			return array(
				...
				'recommended_actions' => array(
					...
					'demo-content'  => array(
						...
						'desc'        => sprintf( esc_html__( 'Customize everything within default WordPress editor %1$s Gutentor : WordPress Page Builder with Unlimited Possibilities to Design %2$s.', 'supermag' ), '<a target="_blank" href="https://www.gutentor.com/" >', '</a>' ),
						'id'          => 'gutentor',
		...
		public function at_theme_info_screen() {
			...
			if (
				...
				$notice_nag = get_option( 'supermag_admin_notice_welcome' );
				if ( ! $notice_nag ) {
					echo '<div class="at-gsm-notice">
                        <small class="plugin-install-notice">' . esc_html__( 'Clicking the button below will install and activate the Acme Demo Setup and Advanced Import plugins.', 'supermag' ) . '</small>
                        <a class="at-gsm-btn button button-primary button-hero" href="#" data-name="" data-slug="" aria-label="' . esc_html__( 'Get started with SuperMag', 'supermag' ) . '">
                         ' . esc_html__( 'Get started with SuperMag', 'supermag' ) . '                   
                         </a>
                    </div>';
				}
...
return new Supermag_Theme_Info();
